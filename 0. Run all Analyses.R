...
source('1. Analysis Growth Intermittent FIN.R')

write.csv(tab_growth_im,file = '~/desktop/MNAR Results/tab_growth_im_fi.csv')
write.csv(es_growth_im,file = '~/desktop/MNAR Results/es_growth_im_fi.csv')
write.csv(conv_growth_im,file = '~/desktop/MNAR Results/conv_growth_im_fi.csv')

source('2. Analysis Growth Dropout FIN.R')

write.csv(tab_growth_do,file = '~/desktop/MNAR Results/tab_growth_do_fi.csv')
write.csv(es_growth_do,file = '~/desktop/MNAR Results/es_growth_do_fi.csv')
write.csv(conv_growth_do,file = '~/desktop/MNAR Results/conv_growth_do_fi.csv')

source('3. Analysis Intensive Intermittent FIN.R')

write.csv(tab_intensive_im,file = '~/desktop/MNAR Results/tab_intensive_im_fi.csv')
write.csv(es_intensive_im,file = '~/desktop/MNAR Results/es_intensive_im_fi.csv')
write.csv(conv_intensive_im,file = '~/desktop/MNAR Results/conv_intensive_im_fi.csv')

source('4. Analysis Intensive Dropout FIN.R')

write.csv(tab_intensive_do,file = '~/desktop/MNAR Results/tab_intensive_do_fi.csv')
write.csv(es_intensive_do,file = '~/desktop/MNAR Results/es_intensive_do_fi.csv')
write.csv(conv_intensive_do,file = '~/desktop/MNAR Results/conv_intensive_do_fi.csv')
